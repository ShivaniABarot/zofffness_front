          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg md:text-xl text-white/90 mb-8">
                Expert guidance to help you craft compelling, authentic college
                application essays.
              </p>
            </div>
          </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-gray-700">
                  From brainstorming to final polish, we offer comprehensive
                  support for all aspects of your college application essays.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                <div className="bg-gray-50 p-6 rounded-xl shadow-sm text-center flex flex-col">
                  ...
                  <p className="text-gray-700 mb-4 flex-grow">
                    Discover unique topics that highlight your strengths,
                    experiences, and personal qualities through guided
                    brainstorming sessions.
                  </p>
                  <p className="font-bold text-college-blue-500">
                    Starting at $150
                  </p>
                </div>
                ...
                <div className="bg-gray-50 p-6 rounded-xl shadow-sm text-center flex flex-col">
                  ...
                  <p className="text-gray-700 mb-4 flex-grow">
                    Work one-on-one with an experienced essay coach who will
                    guide you through the entire writing process, from outline
                    to final draft.
                  </p>
                  <p className="font-bold text-college-blue-500">
                    Starting at $500
                ...
                <div className="bg-gray-50 p-6 rounded-xl shadow-sm text-center flex flex-col">
                  ...
                  <p className="text-gray-700 mb-4 flex-grow">
                    Get detailed feedback on your essays, with suggestions for
                    improvement in content, structure, style, and grammar.
                  </p>
                  <p className="font-bold text-college-blue-500">
                    Starting at $200
                  </p>
              ...
              <div className="bg-college-blue-50 p-8 rounded-xl mb-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="bg-white p-6 rounded-lg shadow-sm">
                    ...
                    <p className="font-bold text-college-blue-500 text-center mb-4">
                      $750
                    </p>
                  ...
                  <div className="space-y-12">
                    <div className="relative grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                      <div className="md:text-right">
                        ...
                        <p className="text-gray-700">
                          We begin by getting to know you—your experiences,
                          values, goals, and what makes you unique. Through
                          targeted exercises and conversations, we'll identify
                          compelling topics that showcase your authentic self.
                        </p>
                      </div>
                      <div className="relative">
                        ...
                        <div className="bg-gray-50 p-6 rounded-lg shadow-sm mt-4 md:mt-0">
                          <p className="italic text-gray-700">
                            "My coach asked me questions no one had ever asked
                            before, which led to an essay topic I never would
                            have considered but that truly represented who I
                            am."
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="relative grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                      <div className="order-2 md:order-1">
                        <div className="relative">
                          ...
                          <div className="bg-gray-50 p-6 rounded-lg shadow-sm mt-4 md:mt-0">
                            <p className="italic text-gray-700">
                              "The structure and outline phase was where
                              everything clicked for me. I finally understood
                              how to organize my thoughts in a way that would
                              captivate readers."
                            </p>
                          </div>
                        </div>
                      ...
                      <div className="order-1 md:order-2 md:text-left">
                        ...
                        <p className="text-gray-700">
                          We'll develop a clear outline and structure for your
                          essay, ensuring it has a compelling beginning,
                          meaningful middle, and powerful conclusion. Then we'll
                          work with you as you develop your initial drafts.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="relative grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                      <div className="md:text-right">
                        ...
                        <p className="text-gray-700">
                          Your coach will provide detailed, constructive
                          feedback on multiple drafts of your essay. We focus on
                          content, structure, voice, and impact, helping you
                          refine your writing to make it more engaging and
                          authentic.
                        </p>
                      </div>
                      <div className="relative">
                        ...
                        <div className="bg-gray-50 p-6 rounded-lg shadow-sm mt-4 md:mt-0">
                          <p className="italic text-gray-700">
                            "The feedback process was invaluable. My coach
                            helped me see where I could dig deeper and where I
                            could be more concise, all while keeping my
                            authentic voice."
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="relative grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                      <div className="order-2 md:order-1">
                        <div className="relative">
                          ...
                          <div className="bg-gray-50 p-6 rounded-lg shadow-sm mt-4 md:mt-0">
                            <p className="italic text-gray-700">
                              "When we finalized my essay, I felt so proud of
                              what I'd created. It was polished but still
                              sounded like me—just the best version of my
                              writing self."
                            </p>
                          </div>
                        </div>
                      ...
                      <div className="order-1 md:order-2 md:text-left">
                        ...
                        <p className="text-gray-700">
                          In the final stage, we'll help you polish your essay
                          to perfection, ensuring it's clear, error-free,
                          adheres to word limits, and most importantly,
                          powerfully communicates who you are to admissions
                          officers.
                        </p>
                      </div>
                    </div>
