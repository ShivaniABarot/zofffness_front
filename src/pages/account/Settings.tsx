                    ...
                    <CardContent className="p-6">
                      ...
                      <nav>
                        <ul className="space-y-2">
                          <li>
                            <a href="#profile" className="flex items-center p-2 rounded-md bg-college-blue-50 text-college-blue-600 font-medium">
                              <User className="h-5 w-5 mr-3" />
                              <span>Profile Information</span>
                            </a>
                          </li>
                          <li>
                            <a href="#security" className="flex items-center p-2 rounded-md text-gray-700 hover:bg-gray-100 transition-colors">
                              <Lock className="h-5 w-5 mr-3" />
                              <span>Security</span>
                            </a>
                          </li>
                          <li>
                            <a href="#notifications" className="flex items-center p-2 rounded-md text-gray-700 hover:bg-gray-100 transition-colors">
                              <Bell className="h-5 w-5 mr-3" />
                              <span>Notifications</span>
                            </a>
                          </li>
                          <li>
                            <a href="#privacy" className="flex items-center p-2 rounded-md text-gray-700 hover:bg-gray-100 transition-colors">
                          ...
                          <div className="border-t border-gray-200 pt-6 mt-6">
                            ...
                            <div className="flex items-center justify-between">
                              ...
                              <div className="flex items-center">
                                <span className="text-red-500 mr-3">Not Enabled</span>
                        ...
                        <div className="space-y-6">
                          <div className="flex items-center justify-between pb-4 border-b border-gray-200">
                            <div>
                              ...
                              <p className="text-sm text-gray-500">Receive updates about your account and services</p>
                            </div>
                          ...
                          <div className="flex items-center justify-between pb-4 border-b border-gray-200">
                            <div>
                              ...
                              <p className="text-sm text-gray-500">Receive information about new services and promotions</p>
                            </div>
                            <label className="relative inline-flex items-center cursor-pointer">
                              <input type="checkbox" checked className="sr-only peer" />
                              <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-college-blue-500"></div>
