                    ...
                    <div className="bg-gray-50 p-4 rounded-lg mb-4 flex items-start">
                      ...
                      <div>
                        ...
                        <div className="flex space-x-3 mt-2">
                          <button className="text-sm text-college-blue-500 hover:underline">
                            Edit
                          </button>
                  ...
                  <CardContent className="p-6 h-full flex flex-col">
                    ...
                    <div className="space-y-4 mb-4">
                      <div>
                        ...
                        <button className="text-sm text-college-blue-500 hover:underline mt-2">
                          Edit Address
                        </button>
                      </div>
                ...
                <div className="flex flex-col md:flex-row gap-8">
                  <div className="md:w-2/3">
                    ...
                    <p className="text-gray-700 mb-5">
                      ...
                      your payments, plans, or billing information.
                    </p>
                    <ul className="space-y-3">
                      <li className="flex items-start">
                        ...
                        <span>
                          <strong>Billing Hours:</strong> Monday - Friday, 9AM -
                          5PM Pacific Time
                        </span>
                      </li>
                      <li className="flex items-start">
                        ...
                        <span>
                          <strong>Email:</strong>{" "}
                          billing@zoffnesscollegeprep.com
                        </span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle2 className="h-5 w-5 text-college-accent-purple mr-2 mt-0.5 shrink-0" />
                  ...
                  <div className="md:w-1/3">
                    <div className="bg-white p-6 rounded-lg shadow-sm">
                      ...
                      <p className="text-gray-700 mb-4 text-center">
                        Need flexible payment options? We offer installment
                        plans for our programs.
                      </p>
