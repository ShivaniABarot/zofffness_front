        ...
        <section className="py-12 bg-white">
          <div className="container mx-auto px-4 md:px-6">
            <div className="max-w-4xl mx-auto prose prose-lg">
              ...
              <p className="mb-6">
                Zoffness College Prep ("we," "our," or "us") respects your privacy and is committed to protecting your personal information. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website or use our services.
              </p>
              <p className="mb-6">
              ...
              <ul className="list-disc pl-6 mb-6">
                <li>Register for our services or programs</li>
              ...
              <p className="mb-6">
                The personal information we may collect includes names, email addresses, phone numbers, mailing addresses, academic information, payment information, and any other information you choose to provide.
              </p>
              ...
              <ul className="list-disc pl-6 mb-6">
                ...
                <li>Request restrictions on certain processing</li>
              ...
              <p>
                <strong>Email:</strong> info@zoffnesscollageprep.com<br />
                <strong>Phone:</strong> (914) 462-7797<br />
                <strong>Address:</strong> 510 West Boston Post Road, Mamaroneck, NY 10543
              </p>
            </div>
          </div>
        </section>
