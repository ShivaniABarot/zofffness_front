          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg md:text-xl text-white/90 mb-8">
                Take full-length, authentic practice tests under realistic
                conditions to prepare for test day success.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-gray-700">
                  Our practice tests simulate the actual testing experience,
                  helping you build confidence and improve your scores.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                <div className="bg-gray-50 p-8 rounded-xl shadow-sm">
                  ...
                  <p className="text-gray-700 mb-6">
                    Take official SAT practice tests in a simulated test
                    environment that mirrors the actual test day experience.
                  </p>
                ...
                <div className="bg-gray-50 p-8 rounded-xl shadow-sm">
                  ...
                  <p className="text-gray-700 mb-6">
                    Experience authentic ACT practice tests with the same
                    timing, format, and content as the actual exam.
                  </p>
                  <ul className="space-y-3 mb-8">
                    <li className="flex items-start">
                      <CheckCircle2 className="h-5 w-5 text-college-accent-purple mr-3 mt-0.5 shrink-0" />
                ...
                <div className="flex flex-col md:flex-row items-center gap-8">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 mb-4">
                      After each practice test, you'll receive a comprehensive
                      score report with detailed analysis of your performance.
                    </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                <div className="text-center">
                  ...
                  <p className="text-3xl font-bold text-college-blue-500 font-display">
                    +150
                  </p>
