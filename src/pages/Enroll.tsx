          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg md:text-xl text-white/90 mb-8">
                Begin your journey to college success by enrolling in our
                comprehensive college preparation programs.
              </p>
            </div>
          </div>
        </section>
                ...
                <div className="lg:col-span-2">
                  <div className="mb-8">
                    ...
                    <p className="text-gray-700">
                      Complete the form below to enroll in one of our programs.
                      After submission, a counselor will contact you to finalize
                      your enrollment and discuss next steps.
                    </p>
                  </div>
                  ...
                  <form className="space-y-6" onSubmit={handleSubmit}>
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea
                        id="goals"
                        placeholder="Briefly describe your academic and college goals"
                        rows={4}
                      />
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea
                        id="questions"
                        placeholder="Do you have any questions or additional information to share?"
                        rows={3}
                      />
                    </div>
                    ...
                    <CardContent className="p-6">
                      ...
                      <ul className="space-y-4">
                        <li className="flex items-start">
                          <div className="bg-college-blue-100 rounded-full h-6 w-6 flex items-center justify-center text-college-blue-500 font-bold text-sm mr-3 mt-0.5 shrink-0">
                            1
                          </div>
                          <div>
                            ...
                            <p className="text-sm text-gray-700">
                              Submit this form with your basic information.
                            </p>
                          </div>
                        </li>
                        ...
                        <li className="flex items-start">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-700">
                              Schedule a meeting with a program counselor.
                            </p>
                          </div>
                        </li>
                        ...
                        <li className="flex items-start">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-700">
                              Finalize your program choice and enrollment
                              details.
                            </p>
                          </div>
                        </li>
                        ...
                        <li className="flex items-start">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-700">
                              Start working with your dedicated counselor or
                              tutor.
                            </p>
                          </div>
                        </li>
                  ...
                  <Card className="card-shadow">
                    <CardContent className="p-6">
                      ...
                      <p className="text-gray-700 mb-4">
                        ...
                        enrollment process, please don't hesitate to contact us.
                      </p>
