          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg md:text-xl text-white/90">
                Take the first step toward personalized guidance for your
                college journey.
              </p>
            </div>
          </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-gray-700">
                  During this session, we'll discuss your goals, answer your
                  questions, and determine how our mentorship program can best
                  support your college aspirations.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                <div className="bg-gray-50 p-8 rounded-xl shadow-sm">
                  ...
                  <ol className="space-y-6">
                    <li className="flex">
                      <div className="bg-college-blue-500 text-white rounded-full h-7 w-7 flex items-center justify-center flex-shrink-0 mt-0.5 mr-3">
                        1
                      </div>
                      <div>
                    ...
                    <li className="flex">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700">
                          Share some information about your goals and interests.
                        </p>
                      </div>
                    </li>
                    <li className="flex">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700">
                          Get an email with meeting details and preparation
                          tips.
                        </p>
                      </div>
                    </li>
                    <li className="flex">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700">
                          Connect via video call to discuss your college
                          preparation needs.
                        </p>
                      </div>
                    </li>
              ...
              <div className="bg-college-blue-50 p-8 rounded-xl text-center">
                ...
                <p className="text-gray-700 mb-6">
                  ...
                  situation and goals. We'll discuss your academic background,
                  extracurricular activities, college aspirations, and any
                  specific challenges you're facing. By the end of the session,
                  you'll have a clear understanding of how our mentorship
                  program can help you achieve your goals.
                </p>
                <p className="text-gray-700 italic">
                  "The consultation was incredibly helpful. I came in feeling
                  overwhelmed about college applications, but left with a clear
                  plan and confidence about the next steps." — Sophia K., Yale
                  '24
                </p>
              </div>
            </div>
