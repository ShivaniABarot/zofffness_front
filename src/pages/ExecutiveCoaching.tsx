          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg md:text-xl text-white/90 mb-8">
                Build essential skills for academic success and lifelong
                achievement through personalized coaching.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-gray-700">
                  Our specialized coaching helps students develop the cognitive
                  ...
                  <div className="flex flex-col md:flex-row gap-8">
                    ...
                    <div className="md:w-2/3">
                      ...
                      <p className="text-gray-700 mb-4">
                        Executive functions are the cognitive processes that
                        enable us to plan, focus attention, remember
                        instructions, juggle multiple tasks, and regulate our
                        actions. These skills are essential for academic
                        achievement and lifelong success.
                      </p>
                      <p className="text-gray-700">
                        Our coaching program helps students strengthen these
                        skills through personalized strategies and consistent
                        practice, leading to improved performance in school and
                        beyond.
                      </p>
                    </div>
                  </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                <Card className="card-shadow card-hover">
                  <CardContent className="p-6">
                    ...
                    <p className="text-gray-700 mb-4">
                      Learn to create effective study schedules, manage
                      assignments, and organize materials.
                    </p>
                ...
                <Card className="card-shadow card-hover">
                  <CardContent className="p-6">
                    ...
                    <p className="text-gray-700 mb-4">
                      Develop strategies to improve concentration and minimize
                ...
                <Card className="card-shadow card-hover">
                  <CardContent className="p-6">
                    ...
                    <p className="text-gray-700 mb-4">
                      Overcome procrastination and develop routines to start and
                      finish assignments effectively.
                    </p>
                    <ul className="space-y-2">
                      <li className="flex items-start">
                        <CheckCircle2 className="h-5 w-5 text-college-accent-purple mr-2 mt-0.5 shrink-0" />
                ...
                <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100">
                  <div className="flex flex-col md:flex-row gap-8 items-start">
                    ...
                    <div className="md:w-2/3">
                      ...
                      <p className="text-gray-700 mb-4">
                        Kelsey is a passionate and dedicated Executive Function
                        Coach with over five years of experience helping
                        students develop lifelong thinking and learning skills.
                        She excels at cultivating abilities, attitudes, and
                        knowledge to help students identify and regulate
                        emotions, pursue positive studying practices, and make
                        responsible decisions through personalized lesson plans.
                      </p>
                      <p className="text-gray-700 mb-4">
                        With a proven track record of organizing and executing
                        hundreds of successful sessions, Kelsey has assisted
                        thousands of students in achieving their unique learning
                        objectives. Her interactive lessons make mastering
                        critical cognitive and developmental skills both
                      ...
                      <div className="bg-gray-50 p-4 rounded-lg">
                        ...
                        <ul className="space-y-2">
                          <li className="flex items-start">
                            ...
                            <span>
                              Bachelor of Arts in English Literature - Florida
                              State University
                            </span>
                          </li>
                          <li className="flex items-start">
                          ...
                          <li className="flex items-start">
                            ...
                            <span>
                              Over 5 years of Executive Function Coaching
                              experience
                            </span>
                          </li>
                        </ul>
              ...
              <div className="bg-college-blue-50 p-8 md:p-12 rounded-xl mb-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div>
                    ...
                    <p className="text-gray-700 mb-4">
                      We begin with a comprehensive assessment to identify your
                      specific executive function strengths and challenges.
                    </p>
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 mb-4">
                      Based on your assessment, we develop a tailored coaching
                      plan with specific strategies and tools.
                    </p>
                    <ul className="space-y-2 mb-6">
                      <li className="flex items-start">
                        <CheckCircle2 className="h-5 w-5 text-college-accent-purple mr-2 mt-0.5 shrink-0" />
