                ...
                <form className="space-y-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="mb-4">
                      ...
                      <p className="text-sm text-gray-600 mt-2">$275/hour per session - Work with a highly qualified and dedicated SAT/ACT instructor who can provide a personalized approach to each student's specific needs.</p>
                    </div>

                    <RadioGroup defaultValue="20sessions">
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="20sessions" id="20sessions" />
                        <Label htmlFor="20sessions">20 session package - $5,500.00</Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="15sessions" id="15sessions" />
                        <Label htmlFor="15sessions">15 session package - $4,125.00</Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="10sessions" id="10sessions" />
                        <Label htmlFor="10sessions">10 session package - $2,750.00</Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="5sessions" id="5sessions" />
                        <Label htmlFor="5sessions">5 session package - $1,250.00</Label>
                      </div>
                    </RadioGroup>
                  </div>
