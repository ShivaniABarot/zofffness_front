...
const teamMembers = [
  ...
  },
  {
    ...
    experience: "Jacob K. Javits Fellow and top instructor with the university's Writing Program",
  ...
  },
  {
    id: 3,
    name: "Caiden Leavitt",
    title: "SAT/ACT Specialist, AP Language, AP Literature, Literature Subject Test, and College Essays",
    education: "B.A. in English Literature from Cornell University",
    experience: "Trained in PAF (Preventing Academic Failure) and TBWS (Teaching Basic Writing Skills)",
  ...
  },
  {
    id: 4,
    name: "Aniruddha Deb",
    title: "SAT/ACT Math, AP Calculus BC/AB, AP Chemistry, & AP Physics Specialist",
    education: "Ph.D in Physics with research on Materials Science and Engineering",
    experience: "Scientist at Lawrence Berkeley National Laboratory, SLAC National Accelerator Laboratory and Japan Synchrotron Radiation Research Institute (JASRI)",
  ...
  },
  {
    ...
    education: "M.A. in English Literature, and dual major B.A. in Creative Writing and Psychology from Hofstra University",
  ...
  },
  {
    ...
    education: "B.S. in Secondary Education: English and Communications from Pennsylvania State University, M.S. in Literacy from Long Island University",
    experience: "Grader for The University of Michigan's Language Assessment Department, Former English Teacher at New Rochelle High School",
  ...
  },
  {
    id: 8,
    name: "Peter O'Byrne",
    title: "SAT/ACT, Algebra I/Algebra II/Trigonometry, Microeconomics/Macroeconomics, & World History Specialist",
    education: "B.A. in Mathematics and Economics from Georgetown University (magna cum laude), M.A. in Secondary Education from National-Louis University",
    experience: "New York State certified in Social Studies and Mathematics, Current Economics Teacher at Mamaroneck High School",
  ...
  },
  {
    id: 9,
    name: "Andrea Coady",
    title: "SAT/ACT Mathematics & Algebra I/Algebra II/Trigonometry/Pre-Calculus Specialist",
    education: "B.S. in Mathematics and M.S. in Mathematics Education from Mercy College (with honors)",
    experience: "11 years of teaching high school mathematics and special education in New York",
  ...
  },
  {
    id: 10,
    name: "Kate Dowling",
    title: "SAT/ACT Language Arts, AP US History/AP World History, & College Essay Specialist",
    education: "B.A., cum laude, from Colgate University in both History and Education, M.A.T. from Teachers College, Columbia University",
    experience: "20+ years of teaching experience, Captain of Colgate University Rowing team",
  ...
  },
  {
    ...
    title: "SAT/ACT, GRE, GMAT, LSAT, ISEE, AB/BC Calculus, AP Statistics, AP Physics, & Chemistry Specialist",
    education: "BA in Mathematics and BS in Physics from Rhodes College, MS in Mathematics from Vanderbilt University",
    experience: "15+ years of tutoring experience, 99th percentile scorer on LSAT, GRE, SAT, and ACT",
  ...
  },
  {
    id: 12,
    name: "Jansen Gibson",
    title: "SAT/ACT, ISEE, AB/BC Calculus, Math and Science Generalist, AP Literature, AP English Composition, College Essay Specialist, & Executive Functioning Coach",
    education: "Focus in Geology and Environmental Sciences from Vanderbilt University",
    experience: "99th percentile scorer on ACT and LSAT exams, experience teaching all age groups",
  ...
  },
  {
    ...
    education: "Concentrated in Music History and French language at Brown University, Master's in Education (TESOL)",
    experience: "30+ years of teaching experience, NYC Teaching Fellow, 5 foreign languages",
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg md:text-xl text-white/90 mb-8">
                Our experienced educators and admissions specialists are dedicated to helping students achieve their academic dreams.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="max-w-4xl mx-auto mb-12 text-center">
              ...
              <p className="text-lg text-gray-700">
                Our team brings decades of combined experience in college admissions, test preparation, essay coaching, and academic mentorship.
              </p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
              {teamMembers.map((member) => (
                <Card key={member.id} className="card-shadow card-hover overflow-hidden">
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="flex space-x-3">
                      <a href="#" className="text-gray-500 hover:text-college-blue-500 transition-colors">
                  ...
                  <div className="flex flex-col md:flex-row">
                    ...
                    <div className="md:w-3/5 p-6 md:p-8 bg-white">
                      <div className="space-y-6">
                        <div className="pb-6">
                          <h4 className="text-lg font-bold text-college-blue-500 mb-2">About</h4>
                        ...
                        <div className="flex items-center space-x-4 pt-4">
                          <Button variant="outline" className="flex items-center space-x-2" asChild>
                            <a href="#" className="text-gray-700 hover:text-college-blue-500">
                              <Linkedin className="h-5 w-5" />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  ...
                  <p className="text-gray-700">
                    Our counselors include former admissions officers from top universities who understand what it takes to craft a successful application from the inside.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    We take the time to understand each student's unique strengths, challenges, and aspirations to provide truly individualized guidance.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Beyond applications, we mentor students in developing the skills and mindset needed for long-term academic and personal success.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Our students consistently gain admission to their top-choice schools, with 95% being accepted to at least one of their top three college choices.
                  </p>
                </div>
              </div>
            </div>
