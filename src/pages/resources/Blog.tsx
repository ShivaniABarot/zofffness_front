  ...
  const blogPosts = [
    {
      ...
      excerpt:
        "Discover unique strategies to make your application memorable to admissions officers at selective institutions.",
    ...
    },
    {
      ...
      excerpt:
        "A comprehensive overview of recent SAT changes and how to adapt your study approach for optimal results.",
      author: "Mark Wilson",
      date: "March 27, 2025",
    ...
    },
    {
      ...
      excerpt:
        "Learn which overused topics admissions officers are tired of seeing and what to write about instead.",
      author: "Sophia Lee",
      date: "March 15, 2025",
      readTime: "7 min read",
      image:
    ...
    },
    {
      ...
      excerpt:
        "Navigate the complex world of college financial aid with these expert tips for maximizing your awards.",
    ...
    },
    {
      ...
      excerpt:
        "Explore how a thoughtfully planned gap year can enhance your college application and personal growth.",
      author: "Emma Thompson",
      date: "February 25, 2025",
      readTime: "9 min read",
      image:
        "https://images.unsplash.com/photo-1473091534298-04dcbce3278c?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80",
    },
    {
      id: 6,
      title: "Crafting an Authentic Personal Statement",
      excerpt:
        "Step-by-step guidance for writing a compelling personal statement that authentically represents your voice.",
      author: "Dr. Jennifer Chang",
        ...
        <section className="pt-96 pb-16 md:pt-48 md:pb-22 bg-gradient-to-r from-college-blue-500/90 to-college-blue-400/70 relative">
          ...
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            <div className="max-w-3xl mx-auto text-center">
              ...
              >
                Expert insights, tips, and strategies to guide you through the
                    ...
                    <div className="flex flex-col md:flex-row">
                      ...
                      <div className="md:w-1/2 p-6 md:p-8">
                        ...
                        <h2 className="text-2xl md:text-3xl font-bold font-display text-college-blue-500 mb-4">
                          2025 College Admissions Trends: What Every Applicant
                          Needs to Know
                        </h2>
                        <p className="text-gray-700 mb-6">
                          The college admissions landscape continues to evolve,
                          with significant changes affecting how applications
                          are evaluated. From test-optional policies becoming
                          permanent at many institutions to the growing emphasis
                          on demonstrated interest and authentic extracurricular
                          involvement, understanding these trends is crucial for
              ...
              <div className="mt-16 bg-college-blue-50 p-8 md:p-12 rounded-xl">
                <div className="text-center mb-8">
                  ...
                  <p className="text-gray-700 max-w-2xl mx-auto">
                    Stay updated with the latest college admissions tips, event
                    announcements, and exclusive content delivered directly to
                    your inbox.
                  </p>
                </div>
