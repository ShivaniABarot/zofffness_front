  ...
  const featuredScholarships = [
    {
      ...
      eligibility:
        "High school seniors with demonstrated academic excellence and leadership",
      description:
        "Annual scholarship awarded to exceptional students who demonstrate academic excellence, leadership qualities, and commitment to community service.",
    },
    {
      id: 2,
      ...
      description:
        "Supports students who have demonstrated leadership abilities in school, extracurricular activities, or community initiatives.",
    },
    {
      id: 3,
      ...
      eligibility:
        "Students pursuing degrees in Science, Technology, Engineering, or Mathematics",
      description:
        "Recognizes students with exceptional achievements in STEM fields and who plan to pursue STEM majors in college.",
    },
  ];
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg md:text-xl text-white/90 mb-8">
                Your comprehensive guide to finding and securing financial
            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-gray-700">
                  Discover scholarships that match your unique profile and learn
                  proven strategies for submitting winning applications.
                </p>
              </div>
                ...
                <div className="w-full md:w-1/2 order-2 md:order-1">
                  <div className="bg-college-blue-50 p-6 md:p-8 rounded-xl">
                    ...
                    <p className="text-gray-700 mb-5">
                      Find scholarships tailored to your academic achievements,
                      interests, background, and career goals.
                    </p>
              ...
              <div className="mb-16">
                ...
                <div className="space-y-6">
                  {featuredScholarships.map((scholarship) => (
                    <Card
                      key={scholarship.id}
                      className="overflow-hidden card-shadow card-hover"
                    >
                      <CardContent className="p-0">
                        <div className="flex flex-col md:flex-row">
                          <div className="md:w-1/4 bg-college-blue-50 p-6 flex flex-col justify-center items-center">
                            ...
                            <div className="text-xl font-bold text-college-blue-500">
                              {scholarship.amount}
                            </div>
                    ...
                    >
                      <CardContent className="p-6">
                        <div className="flex justify-between items-start mb-3">
                          <h4 className="text-lg font-bold text-college-blue-500">
                            {scholarship.name}
                          </h4>
                        ...
                        <Button
                          variant="outline"
                          size="sm"
                          className="w-full text-college-blue-500 border-college-blue-500 hover:bg-college-blue-50"
                        >
                          Learn More
                        </Button>
                      </CardContent>
              ...
              <div className="bg-college-blue-50 p-8 md:p-12 rounded-xl mb-12">
                <div className="flex flex-col md:flex-row gap-8">
                  <div className="md:w-2/3">
                    ...
                    <p className="text-gray-700 mb-5">
                      Let our experts help you maximize your scholarship
                      opportunities with personalized guidance and application
                      support.
                    </p>
                    <ul className="space-y-3">
                      <li className="flex items-start">
                        ...
                        <span>
                          <strong>Scholarship Search:</strong> Customized
                          scholarship matching based on your unique profile.
                        </span>
                      </li>
                      <li className="flex items-start">
                        <Award className="h-5 w-5 text-college-accent-purple mr-2 mt-0.5 shrink-0" />
                        ...
                        <span>
                          <strong>Essay Coaching:</strong> One-on-one assistance
                      ...
                      <li className="flex items-start">
                        ...
                        <span>
                          <strong>Application Review:</strong> Thorough review
                          of your applications to ensure they stand out.
                        </span>
                      </li>
                      <li className="flex items-start">
                        <Award className="h-5 w-5 text-college-accent-purple mr-2 mt-0.5 shrink-0" />
                        ...
                        <span>
                          <strong>Deadline Management:</strong> Organized
                          tracking of application requirements and deadlines.
                        </span>
                      </li>
                    </ul>
                  </div>
                  <div className="md:w-1/3">
                    <div className="bg-white p-6 rounded-lg shadow-sm">
                      ...
                      <p className="text-sm text-center text-gray-600">
                        Our students secure an average of $25,000 in scholarship
                        awards
                      </p>
                    </div>
                  </div>
