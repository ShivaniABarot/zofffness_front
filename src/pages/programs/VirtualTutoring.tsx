          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg md:text-xl text-white/90 mb-8">
                Expert academic support from anywhere in the world, tailored to
                your unique learning needs.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-gray-700">
                  Our virtual tutoring program delivers the same high-quality,
                  personalized instruction as our in-person sessions, with the
                  added convenience of learning from anywhere.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                <div className="bg-gray-50 p-8 rounded-xl shadow-sm">
                  ...
                  <ul className="space-y-3">
                    ...
                    <li className="flex items-start">
                      ...
                      <span>
                        One-on-one sessions with expert tutors in your subject
                        areas
                      </span>
                    </li>
                    <li className="flex items-start">
                      ...
                      <span>
                        Interactive digital whiteboard and collaborative tools
                      </span>
                    </li>
                    <li className="flex items-start">
                      <CheckCircle2 className="h-5 w-5 text-college-accent-purple mr-2 mt-0.5 shrink-0" />
                    ...
                    <li className="flex items-start">
                      ...
                      <span>
                        Regular progress reports and customized study materials
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-gray-50 p-8 rounded-xl shadow-sm">
                  ...
                  <p className="text-gray-700 mb-4">
                    Our secure, user-friendly virtual learning environment is
                    designed specifically for educational success. Features
                    include:
                  </p>
                  <ul className="space-y-2 text-gray-700">
                    ...
                    <li className="flex items-start">
                      ...
                      <span>
                        Interactive digital whiteboard with math symbols
                      </span>
                    </li>
                    <li className="flex items-start">
                      <Monitor className="h-5 w-5 text-college-accent-purple mr-2 mt-0.5 shrink-0" />
