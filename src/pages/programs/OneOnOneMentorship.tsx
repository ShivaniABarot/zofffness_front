          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg md:text-xl text-white/90 mb-8">
                Personalized guidance to help you navigate the college
            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-gray-700">
                  Our mentorship program pairs you with an experienced college
                  admissions expert who will guide you through every aspect of
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                <div className="bg-gray-50 p-8 rounded-xl shadow-sm">
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      ...
                      <span>
                        Personalized mentorship tailored to your unique goals
                        and needs
                      </span>
                    </li>
                    <li className="flex items-start">
                      ...
                      <span>
                        Regular one-on-one sessions with your dedicated mentor
                      </span>
                    </li>
                    <li className="flex items-start">
                      <CheckCircle2 className="h-5 w-5 text-college-accent-purple mr-2 mt-0.5 shrink-0" />
                      ...
                      <span>
                        Comprehensive guidance on college selection and
                        applications
                      </span>
                    </li>
                    <li className="flex items-start">
                    ...
                    <li className="flex items-start">
                      ...
                      <span>
                        Test preparation strategies and academic advising
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-gray-50 p-8 rounded-xl shadow-sm">
                  ...
                  <p className="text-gray-700 mb-4">
                    Our mentors are experienced admissions professionals,
                    including former admissions officers, college counselors,
                    and education specialists with proven success.
                  </p>
                  <p className="text-gray-700">
                    Each mentor is carefully selected for their expertise,
              ...
              <div className="bg-college-blue-50 p-8 md:p-12 rounded-xl mb-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="bg-white p-6 rounded-lg shadow-sm">
                    ...
                    <p className="text-gray-700 mb-4">
                      Early guidance to build a strong foundation for college
                      success. Focus on academic planning, extracurricular
                  ...
                  <div className="bg-white p-6 rounded-lg shadow-sm">
                    ...
                    <p className="text-gray-700 mb-4">
                      Comprehensive preparation during this critical year.
                      Includes college list development, test prep strategy,
                      essay planning, and application roadmap.
                    </p>
                  ...
                  <div className="bg-white p-6 rounded-lg shadow-sm">
                    ...
                    <p className="text-gray-700 mb-4">
                      Focused guidance through application season. Includes
                      essay editing, application review, interview prep, and
                      decision support.
                    </p>
